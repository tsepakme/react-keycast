...
var useHotkeysTs = require('use-hotkeys-ts');
...
function useKeyPresses(options = {}) {
  ...
  (0, import_react.useEffect)(() => {
    const interval = setInterval(() => {
      setPressedKeys(
        (keys) => keys.filter((k) => Date.now() - k.timestamp < timeout)
      );
    }, 200);
...
// src/components/KeyItem.tsx
var import_jsx_runtime = __toESM(require_jsx_runtime());
var KeyItem = ({ keyData, style = {} }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "key-item", style, children: label });
};
...
var KeyOverlay = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      ...
      style: __spreadValues(__spreadValues({}, positionStyles[position]), style),
      children: filteredKeys.map((keyData) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KeyItem, { keyData, style: keyStyle }, keyData.id))
    }
  );
};
